    ...
    <nav className="bg-white fixed w-full z-30">
      <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div className="flex justify-center items-center gap-6">
          ...
          <Link to="/about" className="hover:text-(--primary-color) hover:underline hover:underline-offset-4 ">Services</Link>
          <Link to="/gallery" className="hover:text-(--primary-color) hover:underline hover:underline-offset-4 ">CaseStudy</Link>
          <Link to="/contact" className="hover:text-(--primary-color) hover:underline hover:underline-offset-4">About</Link>
        </div>
      ...
      {open && (
        <div  className={`md:hidden flex flex-col items-center gap-6 pb-10 bg-white shadow-md transition-all duration-300 overflow-hidden ${
          ...
          <Link to="/about" onClick={() => setOpen(false)} className="text-[#333333] font-medium text-[14px]">Services</Link>
          <Link to="/gallery" onClick={() => setOpen(false)} className="text-[#333333] font-medium text-[14px]">CaseStudy</Link>
          <Link to="/contact" onClick={() => setOpen(false)} className="text-[#333333] font-medium text-[14px] mb-4">About</Link>
          <Link to="/donate" onClick={() => setOpen(false)}><button className="bg-(--text-color) flex text-white text-[14px] items-center font-semibold px-4 py-2 rounded-md gap-2 hover:bg-(--primary-color) cursor-pointer"> Work with Us </button></Link>
