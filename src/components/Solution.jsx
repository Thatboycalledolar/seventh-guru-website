...
export default function Solution() {
  return(
    <div className="w-full flex flex-col items-center  py-16 gap-8">
      <div className="bg-(--text-color) w-full px-12 py-4">
      ...
      <div className="flex flex-col items-start px-12 py-8 gap-12">
        ...
        <div className=" gap-3 flex flex-col items-start">
            ...
            <p className="font-light text-(--text-color) text-sm font-body leading-tight w-[80%]">For companies that need clarity, positioning, and credibility. We create stunning visuals that effectively depict the brand and it's core values to represent it both online and prints.</p>
        </div>
        ...
        <div className=" gap-3 flex flex-col items-start">
            ...
            <p className="font-light text-(--text-color) text-sm font-body leading-tight w-[80%]">
        ...
        <div className=" gap-3 flex flex-col items-start">
            ...
            <p className="font-light text-(--text-color) text-sm font-body leading-tight w-[80%]">After creating the brand infrastructure, it’s time to make use of these system to maintain the overall look and performance of your brand. We offer ongoing design leadership and execution for scaling teams.</p>
        </div>
