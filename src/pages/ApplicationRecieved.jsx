...
export default function ApplicationRecieved() {
  return(
    <div className="flex flex-col items-center w-full px-8">
      <div className="flex flex-col items-center gap-6 mb-18 text-(--text-color) mt-24" >
        ...
        <p className="bg-(--background-color) py-8 px-6 text-sm rounded-lg gap-2  text-center mb-12">
